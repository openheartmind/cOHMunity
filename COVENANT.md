...
## 1. Welcome
Open Heart & Mind (OHM) is a diverse community exploring new ways of living, working, and relating together. By participating in the OHM community ("cOHMunity") or using the Wisdom app, you are joining a collective experiment in open collaboration and fair recognition of value.
...
We welcome ongoing dialogue about how our values guide our practices, and will continue to iterate on this list as our community, system and framework evolve.
...
We recognize that value comes in many forms, and are working to honor them all.

Participation is always voluntary. We encourage you to contribute freely, without expectation of return —— while trusting that are working toward fairly recognising all contributions in due course.

## 7. Using Wisdom
Wisdom is our open-source tool for recording and valuing contributions. Community members can:
- Nominate contributions by themselves or others
- Review contributions through pairwise comparisons
- Earn recognition for their reviews and other contributions

Contributions are evaluated across multiple dimensions (e.g., "Gratitude" or "Value to the Mission"), producing collective measures of relative value.

We may also recognise the value of 'negative' contributions, such as payments to members from the collective treasury. If you wish to nominate someone for a negative interaction —— such as violations of our [Code of Conduct](https://github.com/openheartmind/cOHMunity/blob/main/CODE_OF_CONDUCT.md) —— we ask that you first [contact project administrators to discuss](mailto:admin@openheartmind.org).

## 8. Feedback and Disagreement
If you feel that a contribution has been misrepresented or unfairly treated in any way, you can:
- Submit feedback through community channels
- Join the valuation process to influence outcomes
- Contact project administrators to discuss

All data should be interpreted with humility, care, and a spirit of continuous improvement.

## 9. Rewards and Reputation
We may also use Wisdom data to generate reputation metrics, representing the value of contributions over time. These scores may inform governance roles or access to shared resources. However, they are not absolute and should not be treated as measures of personal worth.

Some participants may also receive financial or symbolic rewards in the future, based on community valuation. Any such rewards should be considered gifts (or honorariums) from the community, rather than payment for services or goods. Participants should contribute freely, without expectation of return.
